CREATE TABLE _23b9a24637bd40f68e98af3bcd65045a
                                    WITH (
                                    external_location = 's3://feast-aws-bucket/staging//unload/39c879ea-1291-45cb-aeb6-39ffcafe6d75',
                                    format = 'parquet',
...
WITH entity_dataframe AS (
    ...
    FROM feast_entity_df_31833b057a5e4314aaa4bd291aaef7e4
),
